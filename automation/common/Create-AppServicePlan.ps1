...
New-AzureRmAppServicePlan -Name $ServicePlanName -Location $AzureLocation -ResourceGroupName $ResourceGroupName -Tier Standard -NumberofWorkers 3 -WorkerSize Small
