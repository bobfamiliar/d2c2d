...
Param(
    ...
    [Parameter(Mandatory=$True, Position=2, HelpMessage="The Web Site name.")]
    [string]$WebSiteName,
...
New-AzureRmWebApp -Name $WebSiteName -ResourceGroupName $ResourceGroupName -AppServicePlan $ServicePlanName -Location $AzureLocation
