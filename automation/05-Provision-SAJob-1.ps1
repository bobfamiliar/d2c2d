...
$sajobname1 = "$prefix-send2queue-$suffix"
...
$SAJobPath = Create-SAJob -SAJobName $sajobname1 -SAJobQuery $SAJobQuery1 -IoTHubShortName $IoTHubName -IoTHubKeyName $IoTHubKeyName -IoTHubKey $iothubkey -AzureLocation $AzureLocation -SBNamespace $sbnamespace -SBQueueName messagedrop -SBPolicyName $SBPolicyName -SBPolicyKey $SBPolicyKey
New-AzureRmStreamAnalyticsJob -ResourceGroupName $ResourceGroupName -Name $sajobname1 -File $SAJobPath -Force
Start-AzureRmStreamAnalyticsJob -ResourceGroupName $ResourceGroupName -Name $sajobname1
